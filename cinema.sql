...
select * from account 
update account set vo_hieu_hoa = 0 where username = 'NV0020'
update account set trang_thai = 0 where username = 'NV0001'
delete account where username = 'NV0021'
drop table account
...
delete nhanvien where ma_nhan_vien = 'NV0021'
---------------------------------------------------------------------------------------------------
...
delete ve where ma_ve = 'VE3203191130'
...
insert into ds_ve_dat values('VE8079770510','KH78579922','NV0006','2018-11-18')
insert into ds_ve_dat values('VE0947245640','KH78579922','NV0006','2018-11-18')
insert into ds_ve_dat values('VE0913697630','KH49914715','NV0007','2018-11-18')
insert into ds_ve_dat values('VE8110165524','KH49914715','NV0007','2018-11-18')
insert into ds_ve_dat values('VE0255602055','KH99133496','NV0012','2018-11-18')
insert into ds_ve_dat values('VE0240778165','KH42424669','NV0006','2018-11-18')
insert into ds_ve_dat values('VE4726212687','KH42424669','NV0006','2018-11-18')
insert into ds_ve_dat values('VE0378418056','KH91295215','NV0007','2018-11-18')
insert into ds_ve_dat values('VE3345585604','KH91295215','NV0007','2018-11-18')
insert into ds_ve_dat values('VE6294860006','KH81817816','NV0012','2018-11-18')

insert into ds_ve_dat values ('VE3314690200','KH87271140','NV0006','2018-11-17')
insert into ds_ve_dat values ('VE9016297481','KH87271140','NV0006','2018-11-17')
insert into ds_ve_dat values ('VE0138717214','KH46163013','NV0007','2018-11-17')
insert into ds_ve_dat values ('VE1982333384','KH46163013','NV0007','2018-11-17')
insert into ds_ve_dat values ('VE2903783453','KH68350410','NV0012','2018-11-17')
insert into ds_ve_dat values ('VE8645276319','KH07942366','NV0006','2018-11-17')
insert into ds_ve_dat values ('VE7941588202','KH07942366','NV0006','2018-11-16')
insert into ds_ve_dat values ('VE3853506313','KH00048840','NV0007','2018-11-17')
insert into ds_ve_dat values ('VE3344532589','KH00048840','NV0007','2018-11-18')
insert into ds_ve_dat values ('VE0083547812','KH63093439','NV0012','2018-11-18')



select distinct d.hoten, c.ma_nhan_vien, c.hoten, e.tenphim,  a.ma_ghe, a.ma_rap, f.ngay_chieu, f.gio_chieu, g.dongia
from ve a, ds_ve_dat b, nhanvien c, thanhvien d, phim e, ktg f, gia g
where b.ma_ve = a.ma_ve and b.ma_nhan_vien = c.ma_nhan_vien and b.ma_thanh_vien = d.ma_thanh_vien and a.ma_phim = e.ma_phim and a.ma_ktg = f.ma_ktg and a.ma_gia = g.ma_gia and b.ma_thanh_vien = 'KH78579922'

select c.tenphim as Phim, sum(b.dongia) as 'Doanh thu'
from ve a, gia b, phim c
where a.ma_phim = c.ma_phim and a.ma_gia = b.ma_gia
group by c.tenphim


select d.hoten as 'Tên thành viên', sum(c.dongia) as 'Thành tiền'
...
select * from thanhvien order by stt
select * from ds_ve_dat order by ngay_lap
