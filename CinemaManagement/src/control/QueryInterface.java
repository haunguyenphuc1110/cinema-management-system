...
public interface QueryInterface {
    ...
    //Update enable or disable for account
...
/*===========================================FOR FILM MANAGEMENT==========================================*/
 ...
 /*===========================================FOR EMPLOYEE MANAGEMENT==========================================*/
    ...
    void insertAccount(String idEmployee);
 ...
 /*===========================================FOR BILL MANAGEMENT==========================================*/
    ArrayList<Bill> loadAllBill();
    String findNameMemberByID(String idMember);
    String findNameEmployeeByID(String idEmployee);
    int getPriceBill(String idTicket);
 /*----------------------------------------------------------------------------------------------------------*/
}
